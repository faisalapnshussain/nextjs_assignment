...
const AboutUs = () => {
  return (
    <div>
        <div className='w-1/2 float-left'><h1 className='text-3xl pt-10 pl-10 h-196'>About AH Corporation</h1><p className='text-justify p-10'>
...
In short, we are providing our customers reliable web hosting and web designing services which will make their presence known on World Wide Web.</p></div>
        <div className='float-left w-1/2'><Image
