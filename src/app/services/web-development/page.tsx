...
const websitedevelopment
 = () => {
  return (
    <div className="mx-20"><h2 className="text-3xl">Website Devlopment</h2>
    <p className="text-justify w-[800px]">
    Website Develpment to [Company Name] – Your Trusted Partner for Innovation and Excellence
...
[Contact Button or Contact Information]</p></div>
  )
}
